...
const projectsData = [
  ...
  { name: "FilmFlix", tech: "Spring Boot, JavaScript, Docker, PlayWright, HTML, CSS", description: "Full-Stack movie cataloging application done using agile methodologies such as sprints, kanban boards and weekly stand-ups with our customer.", link: "https://github.com/brandonviaje/FilmFlix", categories: ["Web Dev"] },
